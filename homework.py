def task_1_add_new_record_to_db(con) -> None:
    ...
    with con.cursor() as cursor:
        cursor.execute("""INSERT INTO custumers VALUES(92, "Thomas", "David", "Some Address", "London", "774", "Singapore");""")
...
def task_14_list_products_with_supplier_information(cur):
    ...
    """
    cur.execute(""" 
        SELECT ProductId, ProductName, SupplierName, ContactName, Address, City, PostalCode, Country, Phone FROM suppliers  
        INNER JOIN products ON suppliers.supplierid = products.supplierid    
        ORDER BY ProductId;""")
    return cur.fetchall()
...
def task_15_list_customers_with_any_order_or_not(cur):
    ...
    """
    cur.execute(""" 
        SELECT CustomerName,  Country, OrderID, Customers.CustomerID FROM Customers  
